...
@NamedQueries({
    ...
    @NamedQuery(
            name = JpaConst.Q_EMP_GET_BY_TEAM,
            query = JpaConst.Q_EMP_GET_BY_TEAM_DEF),
    @NamedQuery(
...
public class Employee {
     ...
     * どの会社の従業員か
     */
    @Column(name = JpaConst.EMP_COL_COM, nullable = false)
     ...
     */
    @ManyToOne
    @JoinColumn(name = JpaConst.WAN_COL_TEA, nullable = true)
    private Team team;
