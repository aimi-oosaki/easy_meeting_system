...
public class MinuteAction extends ActionBase{
    ...
    public void entryNew() throws ServletException, IOException {
        ...
        putRequestScope(AttributeConst.MINUTE, new MinuteView()); //空の議事録インスタンス
    ...
    public void edit() throws ServletException, IOException{
        ...
        if (mv == null) {
            ...
            putRequestScope(AttributeConst.MINUTE, mv);//該当の議事録データ
            putRequestScope(AttributeConst.MEETING, mev);//該当の会議データ
            putRequestScope(AttributeConst.AGENDAS, agendas); //該当の議題データ
            putRequestScope(AttributeConst.AGENDA_LIST_SIZE, list_size);
        }
