...
<c:import url="/WEB-INF/views/layout/app.jsp">
    <c:param name="content">
        ...
        <form method="POST" action="<c:url value='/?action=${action}&command=${command}' />">
            ...
            <input style="text-align: left;" type="tel" name="${AttributeConst.EMP_COM_ID.getValue()}" value="${company_id}" />
            <br /><br />
            ...
            <label for="${AttributeConst.EMP_PASS.getValue()}">名前</label><br />
            <input style="text-align: left;" type="password" name="${AttributeConst.EMP_NAME.getValue()}" />
            <br /><br />
